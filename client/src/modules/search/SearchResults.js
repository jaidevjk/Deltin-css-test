                      ...
                      <img
                        ...
                        src={
                            val.photo ===
                                undefined
                                ? NoImg
                                : `http://localhost:1337${val.photo.url}`
                        }
                        width="150px"
                        height="100px"
                                                />
          ...
          {resultArray1.map((val)=>{ 
            ...
            return( 
                    ...
                    <img
                      ...
                      className="zoom"
                      /* Bug Id 2- 
                      Issue - When you click on Location the page goes blank
                      Solution - Replaced 'undefined' with 'null'
                      src={
                          val.photo ===
                              undefined
                              ? NoImg
                              : `https://localhost:1337${val.photo.url}`
                      }*/
                      src={
                        /*I have replaced val.photo === null with !val.photo to check for both undefined and null*/
                          !val.photo 
                              ? NoImg
                              : `http://localhost:1337${val.photo.url}`
                      }
